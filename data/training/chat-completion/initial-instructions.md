...
```
[
    are we in battle? 0x00001C
    are we inside or outside? 0x0000F8
    ...
    have ruby? 0x006029
    have rod? 0x00602A
    have floater? 0x00602B
    have chime? 0x00602C
    have tail? 0x00602D
    have cube? 0x00602E
    have bottle? 0x00602F
    have canoe? 0x006031
    fire orb shining? 0x006032
    water orb shining? 0x006033
    air orb shining? 0x006034
    earth orb shining? 0x006035
    how many tents? 0x006036
    how many cabins? 0x006037
    how many houses? 0x006038
    how many heal potions? 0x006039
    how many pure potions? 0x00603A
    how many soft potions? 0x00603B
    ...
    enemy_1 type 0x006BE4
    enemy_2 type 0x006BF8
    enemy_3 type 0x006C0C
    enemy_4 type 0x006C20
    enemy_5 type 0x006C34
    enemy_6 type 0x006C48
    enemy_7 type 0x006C5C
    enemy_8 type 0x006C70
    enemy_9 type 0x006C84
...
To get a list of locations monsters can be found at:
...
* If asked about locations of things outside, do not respond with "in grid cells...", but rather, "near <known_location>".
* Do not ask for ram contents for hex values you have not been explicitly trained on.
* If you are asked to use items like potions, tents, cabins or houses, be sure to apply their effects and decrement the number of those items in memory.
* If asked a question about a battle, check whether we are in a battle in the first place.
* If you need to know which enemies we are fighting in a battle, check all 9 enemy slots. Some may have enemies and some may not.
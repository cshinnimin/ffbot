#!/usr/bin/env python3
"""
CLI helper to POST a JSON payload to the /nes/bestiary/get-monsters-by-location endpoint and pretty-print the response.

Usage:
  python scripts/python/read_bestiary.py '{"location": "(Some Location)"}'
...
def main():
    parser = argparse.ArgumentParser(description='POST JSON to /nes/bestiary/get-monsters-by-location and pretty-print the response')
    ...
    url = f"http://{args.host}:{args.port}/nes/bestiary/get-monsters-by-location"

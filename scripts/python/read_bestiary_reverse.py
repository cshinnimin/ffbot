#!/usr/bin/env python3
"""
CLI helper to POST a JSON payload to the /nes/bestiary/get-locations-by-monster endpoint and pretty-print the response.

Usage:
  python scripts/python/read_bestiary_reverse.py '{"monsters": ["Goblin","Imps"]}'
...
def main():
    parser = argparse.ArgumentParser(description='POST JSON to /nes/bestiary/get-locations-by-monster and pretty-print the response')
    ...
    url = f"http://{args.host}:{args.port}/nes/bestiary/get-locations-by-monster"
